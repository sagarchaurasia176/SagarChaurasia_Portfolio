...
export const experienceData: ExperienceItem[] = [
  {
    ...
    location: "Remote",
    duration: "June 2025 | Punjab, India",
    responsibilities: [
      "Built and shipped 3+ high-quality web applications using Next.js, delivering fast, responsive, and user-friendly experiences.",
      "Developed a complete MERN stack Admin Dashboard for HR, Admin, and Marketing teams, now used daily by 50+ employees.",
      "Collaborated closely with senior developers to translate requirements into scalable solutions with timely deliveries.",
...

  {
    ...
    jobTitle: "Freelancer",
    location: "Remote",
    duration: "August 2025 | Chandigarh",
    responsibilities: [
